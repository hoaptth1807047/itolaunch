...
jQuery(function($) {
    ...
    /*--------------------------------
         Window Based Layout
     --------------------------------*/
    CRYPTOKIT_SETTINGS.windowBasedLayout = function() {
        var width = window.innerWidth;
        //console.log(width);

        if ($("body").hasClass("chat-open") || $("body").hasClass("sidebar-collapse")) {

            CRYPTOKIT_SETTINGS.mainmenuCollapsed();
            ...
            CRYPTOKIT_SETTINGS.mainmenuScroll();
        }
    ...
    /*--------------------------------
         Window Based Layout
     --------------------------------*/
    CRYPTOKIT_SETTINGS.onLoadTopBar = function() {
    ...
    /*--------------------------------
         CHAT API
     --------------------------------*/
    CRYPTOKIT_SETTINGS.chatAPI = function() {
        ...
        $('.page-topbar .toggle_chat').on('click', function() {
            ...
            if (chatarea.hasClass("hideit")) {
                ...
                //CRYPTOKIT_SETTINGS.mainmenuScroll();
                CRYPTOKIT_SETTINGS.windowBasedLayout();
            }
        });
    ...
    /*--------------------------------
         CHAT API Scroll
     --------------------------------*/
    CRYPTOKIT_SETTINGS.chatApiScroll = function() {
    ...
    /*--------------------------------
         CHAT API window
     --------------------------------*/
    CRYPTOKIT_SETTINGS.chatApiWindow = function() {
        ...
        $(document).on('click', ".chatapi-windows .user-window .controlbar img, .chatapi-windows .user-window .controlbar .minimizeit", function(e) {
            ...
            if (!$(".chatapi-windows #user-window" + id).hasClass("minimizeit")) {
                ...
                CRYPTOKIT_SETTINGS.tooltipsPopovers();
            } else {
    ...
    /*--------------------------------
         Login Page
     --------------------------------*/
    CRYPTOKIT_SETTINGS.loginPage = function() {
    ...
    /*--------------------------------
         Search Page
     --------------------------------*/
    CRYPTOKIT_SETTINGS.searchPage = function() {
    ...
    /*--------------------------------
        Viewport Checker
     --------------------------------*/
    CRYPTOKIT_SETTINGS.viewportElement = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    CRYPTOKIT_SETTINGS.draggablePanels = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    CRYPTOKIT_SETTINGS.breadcrumbAutoHidden = function() {
    ...
    /*--------------------------------
         Section Box Actions
     --------------------------------*/
    CRYPTOKIT_SETTINGS.sectionBoxActions = function() {
    ...
    /*--------------------------------
         Main Menu Scroll
     --------------------------------*/
    CRYPTOKIT_SETTINGS.mainmenuScroll = function() {
    ...
    /*--------------------------------
         Collapsed Main Menu
     --------------------------------*/
    CRYPTOKIT_SETTINGS.mainmenuCollapsed = function() {
    ...
    /*--------------------------------
         Main Menu
     --------------------------------*/
    CRYPTOKIT_SETTINGS.mainMenu = function() {
    ...
    /*--------------------------------
         Mailbox
     --------------------------------*/
    CRYPTOKIT_SETTINGS.mailboxInbox = function() {
    ...
    /*--------------------------------
         Top Bar
     --------------------------------*/
    CRYPTOKIT_SETTINGS.pageTopBar = function() {
    ...
    /*--------------------------------
         Extra form settings
     --------------------------------*/
    CRYPTOKIT_SETTINGS.extraFormSettings = function() {
    ...
    /*--------------------------------
         js tree
     --------------------------------*/
    CRYPTOKIT_SETTINGS.jsTreeINIT = function() {
    ...
    /*--------------------------------
         Vector maps
     --------------------------------*/
    CRYPTOKIT_SETTINGS.jvectorMaps = function() {
    ...
    /*--------------------------------
         DataTables
     --------------------------------*/
    CRYPTOKIT_SETTINGS.dataTablesInit = function() {
    ...
    /*--------------------------------
         Pretty Photo
     --------------------------------*/
    CRYPTOKIT_SETTINGS.loadPrettyPhoto = function() {
    ...
    /*--------------------------------
         Gallery
     --------------------------------*/
    CRYPTOKIT_SETTINGS.isotopeGallery = function() {
    ...
    /*--------------------------------
         Tocify
     --------------------------------*/
    CRYPTOKIT_SETTINGS.tocifyScrollMenu = function() {
    ...
    /*--------------------------------
         Full Calendar
     --------------------------------*/
    CRYPTOKIT_SETTINGS.uiCalendar = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    CRYPTOKIT_SETTINGS.nestableList = function() {
    ...
    /*--------------------------------
         Tooltips & Popovers
     --------------------------------*/
    CRYPTOKIT_SETTINGS.tooltipsPopovers = function() {
    ...
    /*--------------------------------
         iCheck
     --------------------------------*/
    CRYPTOKIT_SETTINGS.iCheck = function() {
    ...
    /*--------------------------------
         Form Editors
     --------------------------------*/
    CRYPTOKIT_SETTINGS.formEditors = function() {
    ...
    /*--------------------------------
         Custom Dropzone
     --------------------------------*/
    CRYPTOKIT_SETTINGS.customDropZone = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    CRYPTOKIT_SETTINGS.otherScripts = function() {
    ...
    /*--------------------------------
        Widgets
     --------------------------------*/
    CRYPTOKIT_SETTINGS.CRYPTOKITWidgets = function() {
    ...
    /*--------------------------------
        weather widget
     --------------------------------*/
    CRYPTOKIT_SETTINGS.CRYPTOKITWidgetWeather = function() {
    ...
    /*--------------------------------
        To Do Task Widget
     --------------------------------*/
    CRYPTOKIT_SETTINGS.CRYPTOKITToDoWidget = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    CRYPTOKIT_SETTINGS.CRYPTOKITToDoAddTaskWidget = function() {
        ...
        $(".wid-add-task input").on('keypress', function(e) {
            if (e.keyCode == 13) {
                ...
                $(this).val("");
                $(this).focus();
                CRYPTOKIT_SETTINGS.iCheck();
                CRYPTOKIT_SETTINGS.CRYPTOKITToDoWidget();
    ...
    /*--------------------------------
         Vector maps
     --------------------------------*/
    CRYPTOKIT_SETTINGS.dbjvectorMap = function() {
    ...
    /*--------------------------------
        IOS7 Switchery
     --------------------------------*/
    CRYPTOKIT_SETTINGS.ios7Switchery = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    CRYPTOKIT_SETTINGS.widgetSparklineChart = function() {
    ...
    $(document).ready(function() {
        CRYPTOKIT_SETTINGS.windowBasedLayout();
        CRYPTOKIT_SETTINGS.mainmenuScroll();
        CRYPTOKIT_SETTINGS.mainMenu();
        CRYPTOKIT_SETTINGS.mainmenuCollapsed();
        CRYPTOKIT_SETTINGS.pageTopBar();
        CRYPTOKIT_SETTINGS.otherScripts();
        CRYPTOKIT_SETTINGS.iCheck();
        CRYPTOKIT_SETTINGS.customDropZone();
        CRYPTOKIT_SETTINGS.formEditors();
        CRYPTOKIT_SETTINGS.extraFormSettings();
        CRYPTOKIT_SETTINGS.tooltipsPopovers();
        CRYPTOKIT_SETTINGS.nestableList();
        CRYPTOKIT_SETTINGS.uiCalendar();
        CRYPTOKIT_SETTINGS.tocifyScrollMenu();
        CRYPTOKIT_SETTINGS.loadPrettyPhoto();
        CRYPTOKIT_SETTINGS.jvectorMaps();
        CRYPTOKIT_SETTINGS.dataTablesInit();
        CRYPTOKIT_SETTINGS.jsTreeINIT();
        CRYPTOKIT_SETTINGS.breadcrumbAutoHidden();
        CRYPTOKIT_SETTINGS.chatAPI();
        CRYPTOKIT_SETTINGS.chatApiScroll();
        CRYPTOKIT_SETTINGS.chatApiWindow();
        CRYPTOKIT_SETTINGS.mailboxInbox();
        CRYPTOKIT_SETTINGS.CRYPTOKITWidgets();
        CRYPTOKIT_SETTINGS.sectionBoxActions();
        CRYPTOKIT_SETTINGS.draggablePanels();
        CRYPTOKIT_SETTINGS.viewportElement();
        CRYPTOKIT_SETTINGS.searchPage();
        CRYPTOKIT_SETTINGS.CRYPTOKITToDoAddTaskWidget();
        CRYPTOKIT_SETTINGS.CRYPTOKITToDoWidget();
        CRYPTOKIT_SETTINGS.dbjvectorMap();
        CRYPTOKIT_SETTINGS.widgetSparklineChart();
        CRYPTOKIT_SETTINGS.CRYPTOKITWidgetWeather();
        CRYPTOKIT_SETTINGS.onLoadTopBar();
        CRYPTOKIT_SETTINGS.ios7Switchery();
        // ------------------------------------------------------- //
        // Coins Slider
        // ------------------------------------------------------ //
        if ($(".coins-slider")){
    ...
    $(window).resize(function() {
        ...
        //CRYPTOKIT_SETTINGS.mainmenuScroll();
        //CRYPTOKIT_SETTINGS.CRYPTOKITWidgetWeather();
        CRYPTOKIT_SETTINGS.isotopeGallery();
        CRYPTOKIT_SETTINGS.loginPage();
        CRYPTOKIT_SETTINGS.widgetSparklineChart();
    });
